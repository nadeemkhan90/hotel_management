...
<?php $con = mysql_connect("localhost","root","");
		...
		$zz = "SELECT * FROM users WHERE user_id = '$_COOKIE[ID_my_site]'";
		$yy=mysql_query($zz);
  ...
  <table width="1260" height="243" border="1" cellpadding="1" cellspacing="1" class="container">
    ...
    <tr>
      <th width="1252" height="170" bgcolor="#FFFFFF" scope="row"><table width="1250" border="0">
          ...
          <tr>
            <td width="192" height="22" bgcolor="#FFFFFF"><div align="center">Product</div></td>
            <td width="21" bgcolor="#FFFFFF"><div align="center">Product Detail</div></td>
            <td width="112" bgcolor="#FFFFFF"><div align="center">Purchasing Date</div></td>
            <td width="187" bgcolor="#FFFFFF"><div align="center">Paid</div></td>
          </tr>
          <tr bgcolor="#E6E6E6">
  <?php  
